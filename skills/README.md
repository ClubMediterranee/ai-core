...
| `export-session` | Documentation | Exports the current AI coding session to Markdown, JSON, or a self-contained HTML file — with agent threads, token counts, and tool call badges. Pluggable provider architecture (currently supports Claude Code). |
