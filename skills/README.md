...
| `export-claude-session` | Documentation | Exports the current Claude Code session to Markdown, JSON, or a self-contained HTML file — with agent threads, token counts, and tool call badges. Claude Code only. |
