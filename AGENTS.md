...
1. Update `skills/README.md` — add a row with name, category, and description
...
1. Update `agents/README.md` — add a row with name and description
...
1. Update `mcps/README.md` — add a row with server name, category, description, auth, and install command
